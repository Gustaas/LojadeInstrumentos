 ...
 * @author paulo
 */
public class TelaRelatorioAnalitico1 extends javax.swing.JFrame {

    Relatorios obj= null;
    
    public TelaRelatorioAnalitico1() {
        initComponents();
    }
    public TelaRelatorioAnalitico1(int idSelecionado) {
        initComponents();
        DefaultTableModel modelo = (DefaultTableModel) TbRelatorioAnalitico.getModel();
        ArrayList<Relatorios> relatorio = RelatoriosDAO.ListarRelatorioDetalhado(idSelecionado);
        
        for(Relatorios item:relatorio){
            modelo.addRow(new String[]{
                String.valueOf(item.getProdutoVenda()),
                String.valueOf(item.getQtd()),
                String.valueOf(item.getValorUni())
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Relatorio Analitico");
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addComponent(BtnVoltarRelatorio, javax.swing.GroupLayout.PREFERRED_SIZE, 103, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addContainerGap())
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGap(18, 18, 18)
                        .addComponent(BtnVoltarRelatorio, javax.swing.GroupLayout.PREFERRED_SIZE, 32, javax.swing.GroupLayout.PREFERRED_SIZE)))
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaRelatorioAnalitico1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TelaRelatorioAnalitico1().setVisible(true);
            }
        });
    }
